  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex gap-6">
        <div className="border-2 w-fit p-4 flex flex-col gap-5 items-center">
          <img src={onlineLearning} alt="" className="h-32" />
          <h2 className="text-xl1 font-semibold">Online learning made easy</h2>
          <p className="text-[.9rem] w-72 p-1">
        ...
        <div className="border-2 w-fit p-4 flex flex-col gap-5 items-center">
          ...
          <h2 className="text-xl1 font-semibold">Conversations First!</h2>
          <p className="text-[.9rem] w-72 p-1">
      ...
      <div className="flex gap-6">
        <div className="border-2 w-fit p-4 flex flex-col gap-5 items-center">
          ...
          <h2 className="text-xl1 font-semibold">Specialized English</h2>
          <p className="text-[.9rem] w-72 p-1">
        ...
        <div className="border-2 w-fit p-4 flex flex-col gap-5 items-center">
          ...
          <h2 className="text-xl1 font-semibold">Diverse Topics</h2>
          <p className="text-[.9rem] w-72 p-1">
